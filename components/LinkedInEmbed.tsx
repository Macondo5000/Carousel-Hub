...
export default function LinkedInEmbed({ embedCode, linkedinUrl }: LinkedInEmbedProps) {
  ...
  if (!embedCode || embedCode.trim() === '') {
    return (
      <div className="w-full min-h-[400px] bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200 flex flex-col items-center justify-center p-8">
        <div className="text-center">
          ...
          <h3 className="text-lg font-medium text-gray-700 mb-2">LinkedIn精彩内容</h3>
          <p className="text-sm text-gray-500 mb-4">
            点击下方链接查看完整的LinkedIn帖子内容
          </p>
          <a
            href={linkedinUrl}
            target="_blank"
